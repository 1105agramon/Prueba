const ganador = ''; // Cadena vacía inicializada pero no utilizada.
...
// Cuando haya un ganador, habilita el elemento 
function mostrarGanador(mensaje) { 
    var ganadorElement = document.getElementById('ganador'); 
    ganadorElement.innerText = mensaje; ganadorElement.style.display = 'block'; // Mostrar el elemento 
}
